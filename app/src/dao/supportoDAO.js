// supportoDAO.js
import { collection, query, where, getDocs } from "firebase/firestore"; // Assicurati che query sia importato
import { db } from "@/firebase/firebase"; // Importa correttamente il database Firestore
