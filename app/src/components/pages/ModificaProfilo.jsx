...
const handleFileChange = (event) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await updateUserProfileWithCV(userId, 
         {
          ...formData,
      ...
      if (response.success) {
        setFeedbackMessage(
          "Modifica completata con successo. Verrai reindirizzato alla Home page tra 3 secondi."
        );
      ...
      console.error("Errore durante la motifica:", err.message);
      setFeedbackMessage(
        err.message || "Errore durante la modifica. Per favore riprova."
      );
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#178563] to-white text-black">
        ...
        <Card className="mx-auto max-w-2xl border-[#178563] border-2 bg-white backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>Compila il form per Modificare come {userType}</CardDescription>
          </CardHeader>
          <CardContent>
            {feedbackMessage && (
              <div
