...
- `type` si riferisce al tipo di branch di cui si tratta, (vedere la sezione precedente Type).
- `descrizione` la descrizione indica qual'è l'operazione che si sta effettuando, qual'è la funzionalità che si sta implementando, i test, ecc.

esempio: feat/home-page
